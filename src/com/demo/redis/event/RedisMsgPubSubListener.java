...
public class RedisMsgPubSubListener extends JedisPubSub {
    private static Logger logger = LogManager.getLogger("RedisMsgPubSubListener");
    ...
    public void startRedisMsgPubSubListener(final Jedis jedis, final RedisMsgPubSubListener redisMsgPubSubListener) {
        ...
        singleThreadPool.execute(() -> {
            ...
            try {
                ...
                logger.error("", e);
                isListen = false;
                // 发生异常后不断重连，消息不可靠，重连期间会发生消息丢失
                startRedisMsgPubSubListener(jedis, redisMsgPubSubListener);
            }
        });
